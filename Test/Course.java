...
public class Course implements Comparable<Course> {
    ...
    public Course(int creditHours, String courseNumber, String courseTitle, int maxEnrollment) {
        ...
        // Assuming Admin.getInstance().addCourse(this); is handled elsewhere or removed if not used
    }
    ...
    public void removeStudent(Student student) {
        if (enrolledStudents.remove(student)) {
            student.removeCourse(this); // Correctly calls removeCourse on Student object
            checkWaitList();
        } else {
            waitList.remove(student);
            student.removeFromWaitList(this); // Correctly calls removeFromWaitList on Student object
        }
    }
    ...
    public void checkWaitList() {
        ...
        while (iterator.hasNext() && enrolledStudents.size() < maxEnrollment) {
